...
{
  return (bitRange(low, 10, 5) == 0b111111) && (bitRange(low, 3, 0) < 12);
}
...
static void case_0x00(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x01(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x02(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x03(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x04(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x05(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x06(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x07(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x08(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x09(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0a(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0b(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0c(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0d(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0e(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x0f(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x10(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x11(uint16_t low, uint16_t high, bool highValid,
                  InstructionOpcode &opcode, Operands &operands) /* 0b10001 */
{
  if (test3R(low)) {
    ...
    switch (bit(low, 4)) {
      case 0:
        DECODE_1R(GETTIME_1r, low);
        break;
    }
  }
}

static void case_0x12(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x13(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x14(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x15(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x16(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x17(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x18(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x19(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x1a(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x1b(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x1c(uint16_t low, uint16_t high, bool highValid,
...
static void case_0x1d(uint16_t low, uint16_t high, bool highValid,
...
static void case_PFIX(uint16_t low, uint16_t high, bool highValid,
...
static void case_EOPR(uint16_t low, uint16_t high, bool highValid,
                  InstructionOpcode &opcode, Operands &operands)
{
  if (!highValid) {
    opcode = ILLEGAL_PC;
      ...
      if (testL6R(high, low)) {
        ...
        switch ((bit(low, 4) << 4) | bitRange(high, 3, 0)) {
          case 0x0c:
            ...
            break;
          case 0x1c:
            DECODE_L2R(BYTEREV_l2r, high, low);
            break;
        }
      }
      break;
